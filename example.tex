...
%			}
			...
			\visible<4->{
				...
				\draw[-{Latex[length=2mm]}, thick] (b.south) to[bend left=20] node[right] {correlations \only<4->{	\footnote{\authortitlefootcite{bridaExperimentalRealizationSubshotnoise2010}
											}}} (c.east);
			}
		\end{tikzpicture}
	\end{center}
			...
			\visible<3->{
				...
				\begin{tikzpicture}
					\begin{axis}[
						...
						% --- Histogram data ---
						\addplot+ [ybar interval,mark=no,fill=black,
