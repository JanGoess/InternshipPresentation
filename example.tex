...
%			}
			...
			\visible<3->{
				\node (b) [right=of p] {\includegraphics[width=.35\textwidth]{Images/ConvImageNoise}};
				% Arrows
			...
			\visible<4->{
				\node (c) [below=of mid] {\includegraphics[width=.35\textwidth]{Images/CoincImageNoise}};
				% Arrows
				
				\draw[-{Latex[length=2mm]}, thick] (b.south) to[bend left=20] node[right] {correlations \only<3->{
										\footnote{\authortitlefootcite{bridaExperimentalRealizationSubshotnoise2010}
											}}} (c.east);
			}
		\end{tikzpicture}
...
%			\end{minipage}
	...
	\begin{frame}{Parameter estimation}
		...
		\visible<4->{\textbf{Estimator:} $\operatorname{Var}(T)$} \vspace*{2em}
...
%	\end{frame}
	...
	\begin{frame}[b]{Coincidence counts}
		\visible<2->{
		\begin{minipage}{.45\textwidth}
			\centering
			Coincidences \\[0.5em]
	...
	\begin{frame}{Noise-to-signal ratio}
		\begin{minipage}{.55\textwidth}
			\centering
			\includegraphics[width=\textwidth]{Images/SimulationSweepSNR_DiffEff.pdf}
		\end{minipage}
		\hfill
		\begin{minipage}{.35\textwidth}
			\resizebox{\linewidth}{!}{%
	...
	\begin{frame}{Summary and Outlook}
		...
		\begin{block}{Outlook:}
			\begin{itemize}
				\item Experimental verification of found parameter regions
				\item Determine the experimental limiations of the variance resolution
			\end{itemize}
		\end{block}
		}
	...
	\begin{frame}{Heralding efficiencies}
		...
		\begin{minipage}{.4\textwidth}
			...
			\[
				\begin{aligned}
				\eta_{\text{sig}} &= \frac{N_{\text{tot,cc}}-N_{\text{ac}}}{N_{\text{tot,idl}}-N_{\text{noise}}} = \frac{\eta_{\text{sig}}\eta_{\text{idl}}N_{\text{g}}}{\eta_{\text{idl}}N_{\text{g}}} \\[1em]
