...
%		\raisebox{-1.8em}{
		%\begin{minipage}{.45\textwidth}
			...
			\hspace*{-1.5em}\includegraphics[width=.5\textwidth]{Images/DC_Idl_2.pdf}
			\visible<3->{
				%\vspace*{1em}
			{\footnotesize
				\[
...
%		\hfill
		...
		%\begin{minipage}{.45\textwidth}
			\centering
			\hspace*{-3em}Idler arm \\
			%\vspace*{-1em}
			\hspace*{6em}\includegraphics[width=.85\textwidth]{Images/SingleStatisticsIdler_5.pdf}
			\\[-1em]
			\visible<3->{
			{\footnotesize
				\hspace*{-12em}
			...
			\begin{minipage}{0.25\textwidth}
				\raisebox{2em}{%
					{\tiny
						\(
					\begin{aligned}
						\eta_{\text{idl}} &= \textcolor{red}{\text{0.09}\%} \\
